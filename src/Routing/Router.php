...
class Router
{
    ...
    public function __construct(DependencyContainer $dependencyContainer)
    {
        ...
        $this->pageMappings = [
            ...
            'addPanier' => [DefaultController::class, 'addPanier'],
            'deletePanier' => [DefaultController::class, 'deletePanier'],
            ...
            'security' => [DefaultController::class, 'security'],
            'accueil' => [DefaultController::class, 'accueil'],
            'ProductListebyType' => [DefaultController::class, 'ProductListebyType'],
